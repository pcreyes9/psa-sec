                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 text-lg font-bold text-green-600">
                                        {{ number_format($weekdayOtHours + $weekendOtHours, 2) }}
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 text-lg font-bold text-blue-600">
                                        ₱{{ number_format($weekendOtPay + $weekdayOtPay, 2) }}
                                    </div>
                                            ...
                                            <tr class="border-t">
                                                ...
                                                <td class="p-3">
                                                    ...
                                                    @if(
                                                        ...
                                                        <div class="text-xs {{ $isWeekend ? 'text-red-500' : 'text-blue-500' }}">

                                                            {{ $isWeekend ? 'Weekend OT (130%)' : 'Weekday OT (125%)' }}
